...
const Hero = () => {
  return (
    <section className="relative w-full h-screen h-[900px] mx-auto hero-background">
      <div
        className={`absolute inset-0 top-[120px]  max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}
      >
        <div className='flex flex-col justify-center items-center mt-5'>
          <div className='w-5 h-5 rounded-full bg-blue-500' />
          <div className='w-1 sm:h-80 h-40 bg-blue-300' />
       </div>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            ...
            I build full-stack web applications and interactive user experiences.<br className='sm:block hidden' />
